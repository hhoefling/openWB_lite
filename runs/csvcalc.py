...
# initramdisk
# python3 OWB/runs/csvcalc.py --input OWB/web/logging/data/daily/ --output OWB/web/logging/data/v001/ --partial OWB/ramdisk/ --mode M >> OWB/ramdisk/csvcalc.log 2>&1 &
# cronNigly
# python3 OWB/runs/csvcalc.py --input OWB/web/logging/data/daily/ --output OWB/web/logging/data/v001/ --partial OWB/ramdisk/ --mode A >> OWB/ramdisk/csvcalc.log 2>&1 &
...
def trdaymonth(irow):
    ...
    #	$ll6_____________	14	17	$NCverbraucher3
    #	$ll7_____________	15	18	$NCll4
    #	$ll8_____________	16	19	$NCll5
    #	$speicherikwh____	17	8	$NCll6
    #	$speicherekwh____	18	9	$NCll7
    #	$d1______________	19	26	$NCll8
...
if __name__ == "__main__":
    ...
    mode = Verarbeitungsmodus
        M -> Rechnen und schreiben von einem Monat (initramdisk)
        A -> Ueberpruefen jeden Monat ab Startjjjj (2018) bis heute, (cronnigly)
    ...
    header = [
            ...
            'Lx4','Lx5','Lx6','Lx7','Lx8','Speicherimp','Speicherexpt',
