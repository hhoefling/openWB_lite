...
<html lang="de">
	...
	<head>
		...
		<title>Logging Jahresansicht (nightly)</title>
		...
		<div role="main" class="container" style="margin-top:20px">
			<div class="row">
				<div class="col" style="text-align: center;">
					<h4>Logging Jahresansicht (nightly)</h4>
				</div>
			</div>
		...
		<script>
			$(document).ready(function(){
				...
				if ( reloadNeeded ) {
					...
					window.location.href = "logging/yearlyv1.php?date=" + parsedDate.getFullYear();
				}
				...
				.on('changeDate', function(e) {
					...
					window.location.href = "logging/yearlyv1.php?date=" + dateToParse;
				});

				// load graph
				$.getScript("logging/yearlychartv1.js?ver=20220209");
			})
		</script>
