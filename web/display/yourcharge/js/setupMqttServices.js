...
var topicsToSubscribe = [
  ...
  ["openWB/lp/1/tagScanInfo", 1],
  ["openWB/lp/1/countPhasesInUse", 1],
  ["openWB/lp/1/kWhDailyCharged", 1],
  ["openWB/lp/1/kWhCounter", 1],
  ["openWB/global/strLastmanagementActive", 1],
  ["openWB/config/get/global/maxEVSECurrentAllowed", 1],
...
var countTopicsNotForPreloader = topicsToSubscribe.filter((row) => row[1] === 1)
  .length;
...
function publish(payload, topic) {
  ...
  var message = new Messaging.Message(
    "local client uid: " + clientuid + " sent: " + topic
  );
