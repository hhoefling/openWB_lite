...
<head>
	...
	<!-- Bootstrap -->
	<link rel="stylesheet" type="text/css" href="css/bootstrap-4.4.1/bootstrap.min.css?v=1234">
	<!-- Normalize -->
    ...
    <script src="<?php echo xgeturl('js/d3.v6.js');?>"></script>
...
<body>
	...
	<div id="altclicker" class="container-fluid px-1 py-3 my-5">		<div class="row d-flex align-items-center py-0 px-2 regularTextSize" style="color: var(--color-fg)">
		<!-- Kopfzeile -->
	  ...
	  this.click(event);
		...
		function processPreloader(mqttTopic) {
			...
			if (!landingpageShown) {
				...
				if (timeBetweenTwoMessages > 1000) {
