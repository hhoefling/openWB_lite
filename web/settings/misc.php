						...
						<div class="form-group">
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  dspeed [0|2|3]</span>
						...
						<div class="form-group">
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  ladetaster [0|1]</span>
						...
						<div class="form-group">
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  bootmodus [0,1,2,3,4]</span>
						...
						<div class="form-group">
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  netzabschaltunghz [0|1]</span>
									<span class="form-text small">
						...
						<div class="form-group">
							...
							<div class="form-row mt-2 mb-1">
								...
								<div class="btn-group btn-group-toggle col" data-toggle="buttons">
									...
									<span class="d_label">openwb.conf  cpunterbrechunglp1 [0|1]</span>
								</div>
							</div>
							<div class="form-row mb-1 lp1cpon disabled">
								...
								<div class="col-md-8">
									<div class="form-row vaRow mb-1">
										...
										<span class="d_label">openwb.conf  cpunterbrechungdauerlp1 [n]</span>
									</div>
									<span class="form-text small">
							...
							<div id="lp2cpdiv" class="disabled">
								<div class="form-row mt-2">
									...
									<span class="d_label">openwb.conf  cpunterbrechunglp2 [0|1]</span>
								</div>
								<div class="form-row mb-1 lp2cpon disabled">
									...
									<div class="col-md-8">
										<div class="form-row vaRow mb-1">
											...
											<span class="d_label">openwb.conf  cpunterbrechungdauerlp2 [n]</span>
										</div>
										<span class="form-text small">
											Die Standardeinstellung ist 4 Sekunden. Falls ein Fahrzeug den Ladevorgang nicht zuverlässig startet, kann dieser Wert erhöht werden.
										<span class="text-danger">Achtung: experimentelle Einstellung!</span>
							...
							<div class="form-row mt-2 mb-1">
								...
								<div class="col">
									<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
										...
										<span class="d_label">openwb.conf  cpunterbrechungmindestlaufzeitaktiv [0|1]</span>
									</div>
									<span class="form-text small">
							...
							<div class="form-row mb-1 cpminlaufzeit disabled">
								...
								<div class="col-md-8">
									...
									<span class="d_label">openwb.conf  cpunterbrechungmindestlaufzeit [n]</span>
									<span class="form-text small">
							...
							<div class="form-row mb-1">
								...
								<div class="col">
									<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
										...
										<span class="d_label">openwb.conf  modbus502enabled [0|1]</span>
									</div>
						...
						<div class="form-group mb-0">
							<div class="form-row vaRow mb-0">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  rfidakt [0|1|2]</span>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group mb-1">
								...
								<div class="form-row">
									<div class="col-lg-4">
										...
										<span class="d_label">openwb.conf  rfidlp1c1 </span>
									</div>
									<div class="col-lg-4">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<span class="d_label">openwb.conf  rfidlp1c2 </span>
									</div>
									<div class="col-lg-4">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<span class="d_label">openwb.conf  rfidlp1c3 </span>
									</div>
								</div>
							</div>
							<div class="form-group mb-1">
								...
								<div class="form-row mb-1">
									<div class="col-lg-4">
										...
										<span class="d_label">openwb.conf  rfidlp2c1 </span>
									</div>
									<div class="col-lg-4">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<span class="d_label">openwb.conf  rfidlp2c2 </span>
									</div>
									<div class="col-lg-4">
										<div class="input-group">
											<div class="input-group-prepend">
										...
										<span class="d_label">openwb.conf  rfidlp2c3 </span>
									</div>
								</div>
							</div>
							<hr class="border-secondary">
							...
							<div class="form-row vaRow mb-0">
								...
								<div class="col">
									<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
										...
										<span class="d_label">openwb.conf  pushbenachrichtigung [0|1] </span>
									</div>
								</div>
							</div>
						</div>
						...
						<div id="pushban" class="disabled">
							<div class="form-group">
								<div class="form-row mb-1">
									...
									<span class="d_label">openwb.conf  pushoveruser [s] </span>
									</div>
								</div>
								<div class="form-row">
									...
									<span class="d_label">openwb.conf  pushovertoken [s] </span>
									</div>
								</div>
							</div>
							<hr class="border-secondary">
							<div class="form-group">
								...
								<div class="form-row mb-1">
									...
									<span class="d_label">openwb.conf  pushbstartl [0|1] </span>
								</div>
								<div class="form-row mb-1">
									<div class="col-md-4">
									...
									<span class="d_label">openwb.conf  pushbstopl [0|1] </span>
								</div>
								<div class="form-row mb-1">
									<div class="col-md-4">
									...
									<span class="d_label">openwb.conf  pushbplug [0|1] </span>
								</div>
								<div class="form-row mb-1">
									<div class="col-md-4">
									...
									<span class="d_label">openwb.conf  pushbsmarthome [0|1] </span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group mb-0">
							<div class="form-row vaRow mb-0">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  ledsakt [0|1] </span>
								</div>
							</div>
						</div>
					</div>
					<div class="card-body disabled" id="ledsan">
						<div class="form-group">
							...
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  led0sofortt [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  led0nurpv [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  led0minpv [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  led0standby [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  led0stop [s] </span>
							</div>
						</div>
						<hr class="border-secondary">
						<div class="form-group">
							...
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  ledsofort [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  lednurpv [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  ledminpv [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  ledstandby [s] </span>
							</div>
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  ledstop [s] </span>
							</div>
						</div>
					</div>
					<script>
					...
					<div class="card-body">
						<div class="form-group mb-0">
							<div class="form-row mb-1">
								...
								<span class="d_label">openwb.conf  displayaktiv [0|1] </span>
							</div>
						</div>
						<div class="disabled" id="displayan">
							<div class="form-group">
								...
								<div class="form-row vaRow mb-1">
									...
									<span class="d_label">openwb.conf  displaysleep [n] </span>
								</div>
								<div class="form-row mb-1">
									<div class="col-md-4">
									...
									<div class="col">
										<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
											...
											<span class="d_label">openwb.conf  displayEinBeimAnstecken [0|1] </span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							<div class="form-row vaRow mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  displaytheme [s] </span>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="form-row mb-1">
								...
								<div class="col">
									<div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
										...
										<span class="d_label">openwb.conf  displaypinaktiv [0|1] </span>
									</div>
								</div>
							</div>
							<div class="form-row mb-1 disabled" id="displaypin">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  displaypincode [s] </span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							<div class="form-row vaRow mb-1">
								...
								<div class="btn-group btn-group-toggle col" data-toggle="buttons">
									...
									<span class="d_label">openwb.conf  hausverbrauchstat [0|1] </span>
								</div>
							</div>
							<div class="form-row vaRow mb-1">
								<div class="col-md-4">
								...
								<div class="btn-group btn-group-toggle col" data-toggle="buttons">
									...
									<span class="d_label">openwb.conf  heutegeladen [0|1] </span>
								</div>
							</div>
							<div class="form-row mb-1">
								...
								<div class="col-md-8">
									<div class="form-row vaRow mb-1">
										...
										<div class="col-10">
											...
											<span class="d_label">openwb.conf  livegraph [n] </span>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							<div class="form-row mb-1">
								...
								<div class="col">
									...
									<span class="d_label">openwb.conf  preisjekwh [f] </span>
